...
echo python3 --default_info_directory_path ../result/default_info --info_directory_path_base ../tmp --engines "${ENGINES}" --input_model_directory_path ../data/problems --output_html_file_path compare_engine.html || exit 1
echo copy -f compare_engine.html /var/www/html/ || exit 1
